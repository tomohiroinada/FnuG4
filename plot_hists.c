...
//	hzCC1->Draw("same");
	...
	TLegend *leg = new TLegend(0.32, 0.73, 0.77, 0.95);
...
//	leg->AddEntry(hzCC1,"CC connected with #geq1 trks","f");
	...
	TH2F *h2ZN = new TH2F ("h2ZN","", 75, offsetZ-1400, offsetZ+100, 41, 1,42);
	h2ZN->SetStats(0);
	nt->Draw("ntracks:z >>h2ZN", "sqrt(x*x+y*y)<100&&CC==1&&ntracks<50", "col");
